   ...
   className="relative z-20 mx-6 mt-6 rounded-2xl bg-linear-to-br from-black/90 via-black/80 to-black/90 backdrop-blur-2xl border border-white/10 shadow-[0_22px_55px_rgba(0,0,0,0.75)] flex items-center justify-between px-8 py-4">
    ...
    <div className = 'flex items-center gap-6 relative'>
        <div className ='relative'>
           ...
           whileHover={{scale:1.07}} whileTap={{scale:0.97}} className ='flex items-center gap-1 px-4 py-2 rounded-full bg-white/10 border border-white/20 text-white text-sm shadow-md cursor-pointer'>
        ...
        ➕
          ...
          className = 'absolute right-[-50px] mt-4 w-64 rounded-2xl bg-black/90 backdrop-blur-xl border border-white/10 shadow-[0_25px_60px_rgba(0,0,0,0.7)] p-4 text-white'>
            ...
            <button onClick ={()=>{setShowCredits(false);navigate("/pricing")}} className ='w-full py-2 rounded-lg bg-linear-to-br from-white to-gray-200 text-black font-semihold hover:opacity-90'>Buy More Credits</button>
        ...
        <div className ='relative'>
           ...
           whileHover={{scale:1.1}} whileTap={{scale:0.97}} className ='flex items-center gap-1 px-4 py-2 rounded-full bg-white/10 border border-white/20 text-white text-sm shadow-md cursor-pointer'>
